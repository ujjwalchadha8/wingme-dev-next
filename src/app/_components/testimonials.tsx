...
export const Testimonials = () => {
  ...
  return (
      <section className="relative py-10">
          <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
              <div className="max-w-xl sm:text-center md:mx-auto">
                  ...
                  {/* <p className="mt-3 text-gray-600">
                      We've helped our clients crack dream roles and at top companies throughout the world.
                  </p> */}
              </div>
              <div className="mt-12">
                  <ul className="grid items-center gap-6 sm:grid-cols-2 lg:grid-cols-3">
                      {
                          testimonials.map((item, idx) => {
                            if (item.type === "youtube") {
                                return <>
                                    <li key={idx} className="bg-white max-w-[95%] rounded-xl border shadow-md transition ease-in-out delay-100">
                            ...
                            return <>
                                <li key={idx} className="bg-white max-w-[95%] rounded-xl border shadow-md transition ease-in-out delay-100">
                                  ...
                                  <figure>
                                      ...
                                      <div className="flex items-center gap-x-4 p-4 mt-6 bg-[#f8d4bf]">
          ...
          <div className="absolute top-0 w-full h-[350px] bg-[#fcede3]">
