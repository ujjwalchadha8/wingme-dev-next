  ...
  const team = [
    {
        ...
        linkedin: "https://unscurry.com",
        twitter: "https://unscurry.com",
    },
    {
          ...
          <div className="max-w-screen-xl mx-auto px-4 md:px-8">
              <div className="max-w-xl">
                  ...
                  <p className="text-gray-600 mt-3">
                      We&apos;re a small team of highly experienced industry professionals. We know what best jobs in the world need and we strive to get you hired!
                  </p>
              </div>
              <div className="mt-12">
                              ...
                              <li key={idx} className="gap-8 sm:flex">
                                  <div className="w-72 h-60">
                                      <Image
                                          ...
                                          width={200}
                                          height={400}
                                          className="max-w-44 w-42 h-full object-cover object-center shadow-md rounded-xl"
                                          alt=""
                                      />
                                  </div>
