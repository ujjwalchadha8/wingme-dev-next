  ...
  const features = [
      {
          ...
          title: "Identify gaps in your skills & resume",
          desc: "We analyze your knowledge, background and resume and investigate the strengths and weaknesses of your profile. "
      },
      {
          icon:
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
          ...
          title: "A strategy to fix & uplift your profile",
      ...
      },
      {
          ...
          title: "An improved Resume with right keywords",
          desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec congue, nisl eget molestie varius, enim ex faucibus purus."
      },
      {
          icon:
          ...
          title: "Optimized LinkedIn & GitHub",
          desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec congue, nisl eget molestie varius, enim ex faucibus purus."
      },
      {
          icon:
